            ...
            <div class="navbar-inner filter">
              <ul class="sui-nav">
                <li :class="{active: isActive('1')}">
                  <a href="javascript:;" @click="setOrder('1')">综合{{getOrderIcon('1')}}</a>
                </li>
                <li>
                  <a href="#">销量</a>
                </li>
                ...
                <li :class="{active: isActive('2')}">
                  <a href="javascript:;" @click="setOrder('2')">价格{{getOrderIcon('2')}}</a>
                </li>
                <!-- <li>
                  <a href="#">价格⬇⬆</a>
                </li>-->
...
export default {
  ...
  methods: {
    ...
    setOrder(orderFlag) {
      // 得到当前项的标识
      // const arr =  this.options.order.split(':')
      // const flag = arr[0]
    ...
    removeCategory() {
      ...
      // 重新获取商品列表
      // this.getProducList()  // 没有去除地址栏query参数
      // 用于删除query参数
    ...
    removeKeyword() {
      ...
      // 通过全局事件总线分发 删除关键字的自定义事件
      this.$bus.$emit("removeKeyword");

      // 重新获取商品列表
      // this.getProducList() 没有去处地址栏params参数
